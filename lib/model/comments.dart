...
class Comments {
  ...
  bool operator ==(Object other) => identical(this, other) || other is Comments &&
     ...
     other.writer == writer &&
     other.childComments == childComments &&
  ...
  int get hashCode =>
    ...
    (content.hashCode) +
    (writer.hashCode) +
    (childComments.hashCode) +
    (createdAt == null ? 0 : createdAt!.hashCode);

  @override
  String toString() => 'Comments[id=$id, content=$content, writer=$writer, childComments=$childComments, createdAt=$createdAt]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (id != null) {
      ...
      _json[r'child_comments'] = childComments;
    if (createdAt != null) {
  ...
  static Comments? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return Comments(
        ...
        childComments: ChildComment.listFromJson(json[r'child_comments'])!,
