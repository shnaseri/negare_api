...
class ChatApi {
  ...
  Future<Response> chatGetAllChatMessagesListWithHttpInfo(String chatCode,) async {
    ...
    final formParams = <String, String>{};
      ...
      queryParams.addAll(_queryParams('', 'chat_code', chatCode));
  ...
  Future<List<ChatGetAllChatsList200ResponseInner>?> chatGetAllChatsList() async {
    ...
    if (response.body.isNotEmpty && response.statusCode != HttpStatus.noContent) {
      final responseBody = await _decodeBodyBytes(response);
      return (await apiClient.deserializeAsync(responseBody, 'List<ChatGetAllChatsList200ResponseInner>') as List)
        .cast<ChatGetAllChatsList200ResponseInner>()
        .toList();
